	...
	config = function()
		require("mini.clue").setup({
			...
			clues = {
				...
				{ mode = "n", keys = "<Leader>i", desc = "+Mini" },
				{ mode = "n", keys = "<Leader>l", desc = "+Lazy" },
				{ mode = "n", keys = "<Leader>m", desc = "+Markdown" },
				{ mode = "n", keys = "<Leader>mf", desc = "+Footnote" },
				{ mode = "n", keys = "<Leader>mh", desc = "+Header" },
				{ mode = "n", keys = "<Leader>mt", desc = "+Table" },
				{ mode = "n", keys = "<Leader>mtd", desc = "+Delete" },
				{ mode = "n", keys = "<Leader>mti", desc = "+Insert" },
				{ mode = "n", keys = "<Leader>mtm", desc = "+Move" },
				{ mode = "n", keys = "<Leader>mts", desc = "+Sort" },
				{ mode = "n", keys = "<Leader>mtv", desc = "+CSV" },
				{ mode = "n", keys = "<Leader>mty", desc = "+Duplicate" },
