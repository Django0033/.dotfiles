return {
    ...
    -- dependencies = {'nvim-telescope/telescope.vim'},
    keys = {
        name = 'Telekasten',
        { '<leader>zn', ':Telekasten find_notes<CR>',         desc = 'Find Notes' },
        { '<leader>zf', ':Telekasten find_friends<CR>',       desc = 'Find Friends' },
        { '<leader>zn', ':Telekasten search_notes<CR>',       desc = 'Grep through Notes' },
        { '<leader>zn', ':Telekasten new_note<CR>',           desc = 'New Note' },
        { '<leader>zt', ':Telekasten new_templated_note<CR>', desc = 'New Templated note' },
        { '<leader>zl', ':Telekasten follow_link<CR>',        desc = 'Follow Link' },
