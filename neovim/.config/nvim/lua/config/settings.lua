...
set.confirm = true -- Confirm to save change before exiting a modified buffer
...
set.showmode = true -- Show mode in cmd line
set.sidescrolloff = 9 -- Minimal number of columns keept right or left the cursor
...
set.timeoutlen = 300 -- Set on the time of the wait between keymaps
